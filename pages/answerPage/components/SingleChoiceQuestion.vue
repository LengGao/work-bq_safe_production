<template>
  <!-- 单选题 -->
  <div class="single-chiuce-question">
    <HtmlParse class="single-chiuce-question-describe">
      <p>
    ...
    <div class="single-chiuce-question-options">
